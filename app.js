...
let timerId;
//key board event handling function
...
//on screen key event handling function
...
//fruit will be drawn if score is. not divisible by 10 and >0
...
//if not divisible by 10 and >0 a new random fruit is drawn
        ...
        else if(score%10==0)
        {
          ...
          fruitY = undefined;
            ...
            goat=true;
            setTimeout(createRandomGoat,200);
